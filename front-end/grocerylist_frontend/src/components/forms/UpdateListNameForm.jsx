    ...
    return (
        <div>
            <form className="flex justify-between" onSubmit={handleSubmit}>
                ...
                className="text-lg bg-transparent border-none p-0 m-0 focus:outline-none focus:ring-0 w-44"></input>
                <button className="ml-auto" type="submit"><Check size={20} /></button>
            </form>
        </div>
    );
}